...
<script src="client/s_mkatkecpkhusus.js"></script>
<h3><div id="loadarea"><i class="icon-th-list"></i>DAFTAR KATEGORI KECAKAPAN KHUSUS</div></h3>
<ol class="breadcrumb">
  <li class="active">Kategori Kecakapan Khusus /</li>
  <li> <a href="kecakapan-khusus">Kecakapan Khusus</a></li>
</ol>
...
<div class="span8"id="i_kegPN" style="display:none;"><br>
	<div class="span8">
		...
		<div class="control-group">
			...
			<div class="controls" >
				<input class="span5"  name="mkatkecpkhususTB" id="mkatkecpkhususTB" required placeholder="kategori kecakapan khusus">
			</div>

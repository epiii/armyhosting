        ...
        <div style="padding-left:20px; padding-top:20px;" class="tabbable" id="tabs-104268">
            <ul class="nav nav-tabs" id="nav-tabs">
                <li class="active">
                    ...
                    <a  title="Pendidikan & Pengajaran" href="#panel1" data-toggle="tab" onclick="return loadData('tampil',1,'','');" style="color:#080"><b>A</b><!-- <span class="badge badge-important">33</span> --></a>
                </li>
                <li >
    ...
    <div class="span8">
       <form autocomplete="off" method="post" enctype="multipart/form-data" 
            ...
            <input type="hidden" id="idformTB" name="idformTB"/>
                ...
                <table class="table table-hover" id="imgTB" width="80%">

          ...
          $out='<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
            <html xmlns="http://www.w3.org/1999/xhtml">
              <head>
                ...
                <title>Daftar Riwayat Pendidikan Informal Anggota (Kwarda Jatim)</title>
              </head>
              ...
              <table class="isix" width="100%" border="0">
                ...
                <p align="center">
                  <b>
                    Riwayat Pendidikan Informal <br>
                  </b>
                </p>
                ...
                <table class="isi" width="100%">
                    ...
                    $nm_kursus     = trim($_GET['nm_kursus'])?$_GET['nm_kursus']:'';
                    $no_sertifikat = trim($_GET['no_sertifikat'])?$_GET['no_sertifikat']:'';
                    $nm_lembaga    = trim($_GET['nm_lembaga'])?$_GET['nm_lembaga']:'';
                    $alamat_pendi  = trim($_GET['alamat_pendi'])?$_GET['alamat_pendi']:'';
                    $thn_kursus    = trim($_GET['thn_kursus'])?$_GET['thn_kursus']:'';

          ...
          $out='<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
            <html xmlns="http://www.w3.org/1999/xhtml">
              <head>
                ...
                <title>Daftar Riwayat Jabatan Anggota (Kwarda Jatim)</title>
              </head>
              ...
              <table class="isix" width="100%" border="0">
                ...
                <table class="isi" width="100%">
                    ...
                    $nm_org   = trim($_GET['nm_org'])?$_GET['nm_org']:'';
                    $nm_jab   = trim($_GET['nm_jab'])?$_GET['nm_jab']:'';
                    $ket_jab  = trim($_GET['ket_jab'])?$_GET['ket_jab']:'';
                  ...
                  if($jum==0){
                    ...
                    while ($res=mysqli_fetch_assoc($exe)) {
                      $out.='<tr>
                            ...
                            <td>'.$res['nm_org'].'</td>
                            <td>'.$res['nm_jab'].'</td>
                            <td>'.tgl_indo($res['tgl_lantik']).'</td>
                            <td>'.tgl_indo($res['tgl_purna']).'</td>
                            <td>'.$res['ket_jab'].'</td>
                            </tr>';
                      $nox++;
                    }

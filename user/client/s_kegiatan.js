...
//image =================================================================================
	...
	function dtkSisaEdit(no,iddtksisa,sisa){
		$('#sisaTD_'+no).html('<form onSubmit="return dtkSisaSave('+no+');" id="sisaFR_'+no+'">'
								...
								+'<input name="sisaTB" id="sisaTB_'+no+'" onkeyup="return angkaValid(\'sisaTB_'+no+'\',\'sisaInfo_'+no+'\');" required  placeholder="wajib diisi"  type="text" maxlength="5" size="5" value="'+sisa+'" >'
	...
	function dtkSisaAdd(no,idkatkeg){
		$('#sisaTD_'+no).html('<form onSubmit="return dtkSisaSave('+no+');" id="sisaFR_'+no+'"><input type="hidden" name="idkatkegTB" value="'+idkatkeg+'"><input required placeholder="wajib diisi" onkeyup="return angkaValid(this);" maxlength="5" size="5" name="sisaTB"  type="text" id="sisaTB_'+no+'" value="0"></form>');
